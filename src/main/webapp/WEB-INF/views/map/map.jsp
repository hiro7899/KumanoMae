	...
	<section class="page-title-area">
		<div class="container">
			...
			<div class="status-bar">
				<span id="selectedArea"><i class="bi bi-geo-alt-fill"></i>
					選択中の地域：全国</span> <span id="lastUpdated"><i
					class="bi bi-clock-history"></i> 最終更新：2026.08.31 14:32</span>
			</div>
		</div>
	</section>
			...
			<form class="filter-form" onsubmit="return false;">
				<div class="filter-row">
					...
					<div class="filter-group">
						<label for="areaSelect">地域</label> <select id="areaSelect"
							name="area" class="form-select">
