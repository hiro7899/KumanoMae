			...
			<section class="signup-complete-card">
				...
				<div class="complete-notice">
					...
					<div>
						...
						<p>
							ご登録いただいたメールアドレス宛に届いた<br> 認証リンクをクリックして、メール認証を完了してください。
						</p>

						<p class="complete-access-note">
							<i class="bi bi-info-circle-fill"></i> 閲覧は可能ですが、投稿・コメントなどの会員機能は
							メール認証後にご利用いただけます。
						</p>
					</div>
				</div>
				...
				<div class="complete-actions">
					<a href="${pageContext.request.contextPath}/"
						...
						class="complete-login-link"> 認証済みの方はこちらからログイン </a>
				</div>
