	...
	<main class="report-container">
		...
		<div class="card-jp-form">
			<form action="${pageContext.request.contextPath}/board/report"
				...
				<!-- 2. 위험도 (RISK_LEVEL) -->
				<div class="mb-4">
					<label class="form-label form-label-jp">危険度区分 <span
						class="text-danger">*</span></label>
					<div
						class="d-flex gap-4 p-3 bg-light border border-2 border-dark rounded">
						<div class="form-check">
							<input class="form-check-input" type="radio" name="riskLevel"
								id="riskDanger" value="DANGER" checked> <label
								class="form-check-label text-danger fw-bold" for="riskDanger">
								<i class="bi bi-exclamation-octagon-fill me-1"></i> 危険 (DANGER)
							</label>
						</div>
						<div class="form-check">
							<input class="form-check-input" type="radio" name="riskLevel"
								id="riskWarning" value="WARNING"> <label
								class="form-check-label text-warning-emphasis fw-bold"
								for="riskWarning"> <i
								class="bi bi-exclamation-triangle-fill me-1"></i> 警戒 (WARNING)
							</label>
						</div>
						<div class="form-check">
							<input class="form-check-input" type="radio" name="riskLevel"
								id="riskCaution" value="CAUTION"> <label
								class="form-check-label text-primary fw-bold" for="riskCaution">
				...
				<div class="mb-4">
					<label for="sightingDate" class="form-label form-label-jp">目撃日時
						...
						class="form-control border-2 border-dark" id="sightingDate"
						name="sightingDate">
				</div>
				...
				<div class="mb-4">
					...
					<div class="row g-2">
						<div class="col-md-6">
							<input type="text"
								class="form-control form-control-sm border-2 border-dark bg-light"
				...
				<div class="mb-4">
					...
					<div class="d-flex flex-wrap gap-2">
						<input type="checkbox" class="btn-check" id="tag1" value="足跡"
							onchange="updateTags()"> <label
							class="btn btn-outline-dark tag-check-label" for="tag1">#
							足跡</label> <input type="checkbox" class="btn-check" id="tag2" value="糞"
							onchange="updateTags()"> <label
							class="btn btn-outline-dark tag-check-label" for="tag2">#
							糞</label> <input type="checkbox" class="btn-check" id="tag3" value="威嚇音"
							onchange="updateTags()"> <label
							class="btn btn-outline-dark tag-check-label" for="tag3">#
							威嚇音</label> <input type="checkbox" class="btn-check" id="tag4" value="成獣"
							onchange="updateTags()"> <label
							class="btn btn-outline-dark tag-check-label" for="tag4">#
							成獣</label> <input type="checkbox" class="btn-check" id="tag5" value="親仔"
							onchange="updateTags()"> <label
							class="btn btn-outline-dark tag-check-label" for="tag5">#
							親仔</label>
					</div>
					<!-- 실제 DB로 전송되는 히든 필드 -->
				...
				<div class="mb-5">
					...
					<textarea class="form-control border-2 border-dark" id="content"
						name="content" rows="5"
				...
				<!-- 하단 버튼 영역 -->
				<div
					class="d-flex justify-content-between align-items-center pt-3 border-top border-2">
					<a href="${pageContext.request.contextPath}/"
						class="btn btn-jp-outline px-4">キャンセル</a>
					<button type="submit" class="btn btn-jp-mustard btn-lg px-5">報告を送信する
						→</button>
				</div>
			</form>
		</div>
